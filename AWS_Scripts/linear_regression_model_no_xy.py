...
lr = f.Model(model=LinearRegression, name="LinearRegression_NoXY")
...
columns = data.columns.drop(["opt_value", "x", "y"])
print("Starting training...")
lr.spatial_cv(data, columns, target_normalized=True, tune_hyperparameters=False)
