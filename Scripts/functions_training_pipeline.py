...
class Model:
    ...
    def spatial_cv(self, df, columns, target_normalized):
        ...
        for outer_split in df["outer_area"].unique():
            ...
            # best_hyperparam = self.__tune_hyperparameters(train, columns, split_variable_name="inner_area")  # CHANGE BACK FOR OHTER MODELS
            best_hyperparam = self.hyperparameters
        ...
        # final_hyperparameters = self.__tune_hyperparameters(df, columns, split_variable_name="final_split_areas")  # CHANGE BACK FOR OHTER MODELS
